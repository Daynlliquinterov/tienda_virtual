...
$(document).ready(function(){
	const host = 'http://localhost/tienda_virtual/Assets/';
	
	//ONLOAD
	$("#preview_front").css('background-image', 'url(' + host + 'tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_front.png) ') ;
	$("#preview_back").css('background-image', 'url(' + host + 'tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_back.png) ') ;
	...
	$("#o_front").click(function(){
		$y_pos="front";
				$("#preview_front").css('background-image', 'url(' + host + 'tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_'+$y_pos+'.png) ') ;
				$("#o_front").attr('src', host + 'tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_front.png');
				$("#o_back").attr('src', host + 'tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_back.png');
	...
	$("#o_back").click(function(){
		$y_pos="back";
				$("#preview_back").css('background-image', 'url(' + host + 'tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_'+$y_pos+'.png) ') ;
				$("#o_front").attr('src',host + 'tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_front.png');
				$("#o_back").attr('src',host + 'tdesignAPI/images/product/'+$type+'/'+$color+'/'+$color+'_back.png');
...
/*=====================SAMPLE ICONS========================*/
	...
	$(".folder_toggle").click(function(){
		...
		$.ajax({
			      url: host + 'tdesignAPI/control/newcontent.php?folder='+$folder,
			      success: function()
		      	{
		        	$("#toggle_show"+$i ).empty().load(host + "tdesignAPI/control/newcontent.php?folder="+$folder);
		      	}
	    });
	});
/*=====================SAMPLE ICONS over========================*/
	...
	$y_pos="front";
	 html2canvas($('#preview_front'), {
            onrendered: function(canvas) {
				...
				$('#img_front').val(canvas.toDataURL());
            }
        });
	//$('#preview_front').hide();
	//$('#preview_back').show();
