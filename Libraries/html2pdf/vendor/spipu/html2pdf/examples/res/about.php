...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
    ...
    <div style="text-align: center; width: 100%;">
        <br>
        <img src="./res/logoPeque.png" alt="Logo Html2Pdf" style="width: 150mm">
        <br>
    </div>
    <br><br><br><br><br>
    <div class="note">
...
<page pageset="old">
    ...
    <ul class="main">
        ...
        <li>&lt;code&gt;, &lt;pre&gt;</li>
        <li>&lt;div&gt; :&nbsp;<div style="border: solid 1px #AADDAA; background: #DDFFDD; text-align: center; width: 50mm">exemple de DIV</div>
        </li>
