...
<div class="container design_api_container">
	<div class='design_api'>
		...
		<div id='options'>
			<div class="T_type">
				<div id="radio1"><img src="tdesignAPI/images/menu_icons/submenu/hoodie_sincapota.png" width="100%" height="100%" />
				</div>
				<div id="radio3"><img src="tdesignAPI/images/menu_icons/submenu/hoodie.png" width="100%" height="100%" />
				</div>
			</div>
		...
		<div id='view_mode'>
			...
			<div class="mode"><img id="o_back" src="tdesignAPI/images/product/tee/black/black_back.png" width="100%" height="80%" />ATRAS
			</div>
			<div class="mode">
...
<script>
	...
	$('#btn-add-custom-product').click(function(){
		...
		request.open("POST",'http://localhost/tienda_virtual/Controllers/Productos/createCustomProduct',true);
		...
		// $.ajax({
		// 	data: formData,
		// 	url: 'localhost/tienda_virtual/Productos/createCustomProduct',
		// 	type: 'POST',
		// 	processData: false,
