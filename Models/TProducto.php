...
trait TProducto{
	...
	public function createProduct($talla, $img_front, $img_back){
		$this->con = new Mysql();
		$sql = "
			INSERT INTO producto (categoriaid, codigo, nombre, descripcion, precio, stock, imagen, ruta, img)
			VALUES (?,?,?,?,?,?,?,?,?)";
